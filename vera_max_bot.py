...
def build_daily_slots(msk_now: datetime):
    ...
    midday_rotation = {
        ...
        2: ("история святого", "story", "Используй только сведения, переданные в контексте; если их недостаточно, дай общий практический урок без биографических выдумок."),
        ...
        5: ("житие и пример", "story", "Расскажи только проверяемую мысль о христианской добродетели; не придумывай чудеса и исторические детали."),
...
def special_slots(msk_now: datetime):
    ...
    if wd == 5:
        return [(11, "житие недели", "life", "Расскажи только проверяемый общий урок из жития святого; не выдумывай факты и чудеса.")]
    if wd == 6:
